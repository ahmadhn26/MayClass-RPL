...
<body>
                ...
                @php
                    ...
                    $menuItems = [
                        ...
                        [
                            ...
                            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6"><path stroke-linecap="round" stroke-linejoin="round" d="M2 10h20M2 14h20m-9 4h9a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H2v16z"/><path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.01M10 6h.01"/></svg>',
                            'route' => 'admin.payment-methods.index',
                            'patterns' => ['admin.payment-methods.*'],
                        ],
                        [
                            ...
                            'patterns' => ['admin.landing-content.*', 'admin.documentations.*'],
                        ],
                    ];
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const logoutButtons = document.querySelectorAll('.logout-btn button');
