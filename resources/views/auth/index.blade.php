    ...
    <style>
        ...
        *::after {
        ...
        .auth-container {
            ...
            /* Sedikit lebih solid agar teks jelas */
    ...
    @if (session('register_success'))
        <div class="terms-modal is-visible" style="z-index: 2000;">
            <div style="background:#fff; padding:32px; border-radius:20px; text-align:center; max-width:320px;">
                <div
                    style="width:56px; height:56px; background:#ecfdf5; color:#10b981; border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 16px; font-size:28px;">
                    ✓</div>
    ...
    <div class="auth-container">
        ...
        <form data-mode="register" method="post" action="{{ route('register.details') }}" class="auth-form" novalidate>
            ...
            <div class="input-row">
                ...
                <div class="input-group">
                    ...
                    <input class="input-field" type="tel" name="phone"
                        value="{{ old('phone', $profileData['phone'] ?? '') }}" required>
            ...
            <div class="terms-trigger-wrapper">
                <input type="checkbox" id="main-terms-check" required
                    onclick="if(!this.checked) { toggleRegisterButton(); return; } event.preventDefault(); toggleTerms(true);">
                <label for="main-terms-check" style="font-size: 0.9rem; color: var(--neutral-500);">
                    Saya menyetujui <button type="button" class="terms-btn" onclick="toggleTerms(true)">Ketentuan
                        Layanan</button>.
                </label>
            </div>
            ...
            <a href="{{ route('auth.google', ['mode' => 'register']) }}" class="btn-google">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M23.52 12.29C23.52 11.46 23.45 10.66 23.32 9.9H12V14.51H18.47C18.18 15.99 17.34 17.25 16.08 18.1L19.94 21.1C22.2 19.01 23.52 15.92 23.52 12.29Z"
                        fill="#4285F4" />
                    <path
                        d="M12 24C15.24 24 17.96 22.92 19.94 21.1L16.08 18.1C15 18.83 13.62 19.26 12 19.26C8.87 19.26 6.22 17.15 5.28 14.29L1.29 17.38C3.26 21.3 7.31 24 12 24Z"
                        fill="#34A853" />
                    <path
                        d="M5.28 14.29C5.03 13.43 4.9 12.52 4.9 11.6C4.9 10.68 5.03 9.77 5.28 8.91L1.29 5.82C0.47 7.47 0 9.49 0 11.6C0 13.71 0.47 15.73 1.29 17.38L5.28 14.29Z"
                        fill="#FBBC05" />
                    <path
                        d="M12 3.93C13.76 3.93 15.34 4.54 16.58 5.73L19.99 2.33C17.95 0.43 15.24 0 12 0C7.31 0 3.26 2.7 1.29 5.82L5.28 8.91C6.22 6.05 8.87 3.93 12 3.93Z"
                        fill="#EA4335" />
                </svg>
                Google
            </a>
    ...
    <div class="terms-modal" id="terms-modal" aria-hidden="true">
        <div class="terms-dialog">
            ...
            <div class="terms-body">
                ...
                <p>MayClass menyediakan platform belajar terpadu. Anda wajib memberikan nama, username, email, dan nomor
                    telepon yang valid untuk membangun profil pembelajaran.</p>
                ...
                <p>Konten belajar tersedia dinamis sesuai paket. Jadwal kelas mengikuti sesi yang dirancang tentor. Kami
                    mencatat progres untuk pengalaman belajar yang konsisten.</p>
                ...
                <p>Kami menggunakan informasi kontak untuk pengingat jadwal dan komunikasi dukungan. Kami tidak menjual
                    data pribadi ke pihak ketiga di luar keperluan layanan inti.</p>
