...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        /* Header Text */
        .header-text { text-align: center; margin-top: 32px; margin-bottom: 24px; }
        ...
        .summary-title {
            ...
            color: var(--neutral-500); letter-spacing: 0.05em; margin-bottom: 12px;
            border-bottom: 1px solid var(--neutral-200); padding-bottom: 8px;
        }
        ...
        .summary-value { font-weight: 600; color: var(--neutral-900); text-align: right; }
        ...
        .btn-primary {
            background: var(--primary-600); color: white; border: none; width: 100%;
        ...
        .form-helper {
            font-size: 0.85rem; color: var(--neutral-500); text-align: center; margin-top: 16px; margin-bottom: 4px;
        }

        /* Link di Bawah (Edit Data) */
        .auth-footer {
            margin-top: 12px; text-align: center; font-size: 0.9rem; color: var(--neutral-500);
        }
        .action-link { color: var(--primary-600); font-weight: 600; text-decoration: underline; }

        /* Recaptcha Wrapper */
        .recaptcha-wrapper { display: flex; justify-content: center; margin-top: 10px; }

        @media (max-width: 600px) { .auth-container { padding: 30px 24px; } }
    </style>
</head>
<body>
