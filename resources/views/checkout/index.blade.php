...
<body>
    ...
    <div class="checkout-container">
        ...
        <main class="card">
            ...
            <div class="timer-box" data-countdown data-remaining="{{ $seconds }}"
                data-expire-endpoint="{{ $expireRoute }}">
                <div>
                    <span
                        style="display:block; font-size:0.8rem; font-weight:700; text-transform:uppercase; letter-spacing:0.05em;">Sisa
            ...
            <form method="post" action="{{ $pkgSlug ? route('checkout.process', $pkgSlug) : '#' }}"
                ...
                <div class="form-group">
                    ...
                    <div class="upload-wrapper">
                        <input type="file" id="payment-proof" name="payment_proof" accept=".jpg,.jpeg,.png,.pdf"
        ...
        <aside class="card summary-card">
            ...
            <div class="summary-item total">
                ...
                <span style="color: var(--primary);">Rp {{ number_format($pkgPriceNum, 0, ',', '.') }}</span>
            </div>

            <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid var(--border);">
                <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 12px;">Ada kendala pembayaran?
                </p>
