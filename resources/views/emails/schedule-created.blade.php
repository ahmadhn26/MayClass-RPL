...
<head>
    ...
    <title>Jadwal Baru - MayClass</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 30px 0; font-size: 16px; color: #374151; line-height: 1.6;">
                                Jadwal belajar baru telah ditambahkan untuk Anda. Berikut detail jadwal:
                            </p>
                            ...
                            <p style="margin: 0 0 20px 0; font-size: 14px; color: #6b7280; line-height: 1.6;">
                                Pastikan Anda hadir tepat waktu. Jika ada pertanyaan, silakan hubungi admin MayClass.
                            </p>
