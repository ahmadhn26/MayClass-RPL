...
<head>
    ...
    <title>Pengingat Jadwal - MayClass</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 30px 0; font-size: 16px; color: #374151; line-height: 1.6;">
                                Ini adalah pengingat bahwa Anda memiliki jadwal belajar <strong>BESOK</strong>. Pastikan
                                Anda siap untuk mengikuti kelas.
                            </p>

                            <!-- Schedule Card -->
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                style="background-color: #f0fdf4; border: 2px solid #16a34a; border-radius: 8px; margin-bottom: 30px;">
                                <tr>
                                    <td style="padding: 24px;">
                                        <h2
                                            style="margin: 0 0 20px 0; color: #16a34a; font-size: 18px; font-weight: 600; border-bottom: 2px solid #16a34a; padding-bottom: 12px;">
                            ...
                            <!-- Preparation Tips -->
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0"
                                style="background-color: #f9fafb; border-radius: 8px; margin-bottom: 30px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <h3
                                            style="margin: 0 0 12px 0; color: #374151; font-size: 14px; font-weight: 600;">
                                            Persiapan sebelum kelas:</h3>
                                        <ul
                                            style="margin: 0; padding-left: 20px; color: #6b7280; font-size: 14px; line-height: 1.8;">
                                            <li>Siapkan alat tulis dan buku catatan</li>
                                            <li>Pastikan koneksi internet stabil (untuk kelas online)</li>
                                            <li>Review materi sebelumnya jika ada</li>
                                            <li>Hadir 5-10 menit sebelum jadwal dimulai</li>
                                        </ul>
                                    </td>
                                </tr>
                            </table>
